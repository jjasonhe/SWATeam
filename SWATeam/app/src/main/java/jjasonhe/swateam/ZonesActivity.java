...
public class ZonesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDestroy = (TextView) findViewById(R.id.tvDestroy);
        tvDestroy.setTypeface(montserratR);
    ...
    public void clickHelp(View view) {
        Intent intent = new Intent(this, Help1Activity.class);
    ...
    public void onRadioPoopClick(View view) {
        boolean checked = ((RadioButton) view).isChecked();
        switch(view.getId()) {
            case R.id.radioPoopY:
                if (checked)
                    poop = true;
                break;
            case R.id.radioPoopN:
                if (checked)
                    poop = false;
                break;
        }
    ...
    public void onRadioDestroClick(View view) {
        boolean checked = ((RadioButton) view).isChecked();
        switch(view.getId()) {
            case R.id.radioDestroY:
                if (checked)
                    destro = true;
                    break;
            case R.id.radioDestroN:
                if (checked)
                    destro = false;
                    break;
        }
